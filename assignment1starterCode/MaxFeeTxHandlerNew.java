...
/**
 * Create a second file called MaxFeeTxHandler.java whose handleTxs() method finds a set of
 * transactions with maximum
 * total transaction fees -- i.e. maximize the sum over all transactions in the set of (sum of
 * input values - sum of
 * output values)).
 */
public class MaxFeeTxHandlerNew extends TxHandler {
     ...
     * constructor.
     */
    public MaxFeeTxHandlerNew(UTXOPool utxoPool) {
        super(utxoPool);
    }
